						...
						<div class="single_product_pics">
							<div class="row">
								<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
									<table>
										<tr>
											<td><input type="file" name="anh_slide1"></td>
											<td rowspan="3" ><input type="file" name="anh_sanpham"></td>
										</tr>
										<tr>
											<td><input type="file" name="anh_slide2"></td>									
										</tr>
										<tr>
											<td><input type="file" name="anh_slide3"></td>									
										</tr>
									</table>
								</div>
					...
					<div class="col-lg-5">
						<div class="product_details">
							<div class="product_details_title">
								<h2><input type="text" name="tensanpham" placeholder="Nhập Tên Sản Phẩm"></h2>
								<p><textarea rows=" 3" cols="50" name="gioithieu" placeholder="Nhập giới thiệu nhắn (Nhập </br> để xuống dòng)"></textarea></p>
							</div>
							<div class="free_delivery d-flex flex-row align-items-center justify-content-center">
								<span class="ti-truck"></span><span>Mỹ Phẩm</span>
							</div>
							<div class="original_price"><input type="text" name="Giacu" placeholder="Nhập giá cũ"> VND</div>
							<div class="product_price"><input type="text" name="Giamoi" placeholder="Nhập giá mới"> VND</div></br></br>
					...
					<div class="row">
						<div class="col">
							...
							<div id="tab_1" class="tab_container active">
								<div class="row">
									<div class="col-lg-5 desc_col">
										...
										<div class="tab_text_block">
											<h2><input type="text" name="tieude1" placeholder="Nhập tiêu đề 1"></h2>
											<p><textarea rows=" 5" cols="50" name="noidung1" placeholder="Nhập nội dung mô tả"></textarea></p>
										</div>
										<div class="tab_image">
											<input type="file" name="anhmau1">
										</div>
										<div class="tab_text_block">
											<h2><input type="text" name="tieude2" placeholder="Nhập tiêu đề 2"></h2>
											<p><textarea rows=" 5" cols="50" name="noidung2" placeholder="Nhập nội dung mô tả"></textarea></p>
										</div>
									</div>
									<div class="col-lg-5 offset-lg-2 desc_col">
										...
										<div class="tab_text_block">
											<h2><input type="text" name="tieude3" placeholder="Nhập tiêu đề 3"></h2>
											<p><textarea rows=" 5" cols="50" name="noidung3" placeholder="Nhập nội dung mô tả"></textarea></p>
										</div>
								...
								<div align='center'><input type="submit" name="themsanpham" id="" value="Thêm Thông tin"></div>
							</div>
							...
							<?php
								...
								if(isset($_POST['themsanpham']))
								{
									...
									$insertAll = $insert->insert_Sanpham($tenSP,$anhSP,$GiaCu,$GiaMoi,$PhanLoai,$anhslide1,$anhslide2,$anhslide3 , $gioithieu , $tieude1 , $tieude2 , $tieude3 , $noidung1 , $noidung2 , $noidung3 , $anhmau1 , $anhmau2 , $anhmau3);
										echo "<h3>Thêm Sản phẩm thành công<h3>";
								}

	...
	<div class="main-panel">
     ...
     <form method="post" enctype="multipart/form-data">     
        <div id="quanly_gioithieu">
                    <h3><input type="submit" id="them" name="them" value="Thêm"></h3>
                <Table>
                    <tr>
                        ...
                        <tr>
                            <td><input type="file" name="hinhanh" id="upanh"></td>
                        
                            <td><textarea name="noidung" id="" cols="70" rows="10"></textarea></td>
                                    ...
                                    $insert = new data();
                                        ...
                                        if(isset($_POST['them'])&&($_POST['them']))
                                        {
                                            ...
                                            $anhgioithieu=$uphinh;
                                            $upanh=$insert->insert_gioithieu($anhgioithieu,$noidung);
                                        }
                                    ?>
		</form> 

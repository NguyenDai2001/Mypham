...
<div class="wrapper">
	...
	<div class="main-panel">
        ...
        <div id="quanly_gioithieu">
                    <h3>Quản Lý Giới Thiệu (<a href="gioithieu_Them.php?mk=<?php echo md5($user['password'])."".md5($user['name']); ?>"> Thêm <i class="fa-solid fa-plus"></i></a>)</h3>
                    ...
                    foreach($select as $se)
                     ...
                     ?>
                        ...
                        <tr>
                            ...
                            <td><img src="../images/anh_gioithieu/<?php echo $se['anh_gioithieu'] ?>" width="200px"></td>
                       
                            <td><?php echo $se['noidung'] ?></td>
                            <td><a href="gioithieu_sua.php?updatagioithieu=<?php echo $se['id'].'&&mk='.md5($user['password'])."".md5($user['name']) ?>"><i class="fa-solid fa-pen-clip"></i></td>

                            <td><a href="gioithieu_xoa.php?deletegioithieu=<?php echo $se['id'].'&&mk='.md5($user['password'])."".md5($user['name']) ?>"><i class="fa-solid fa-trash"></a></i></td>
